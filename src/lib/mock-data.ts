...
[Your name]`,
  ...
  },
  {
    ...
    contactId: "con_002",
    channel: "linkedin",
    body: `Hi James — I follow Riverside State's work on aid verification. Would value connecting to share how peer institutions are addressing the state audit findings.`,
    actionId: "act_001",
